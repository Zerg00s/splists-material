# SPPP + PnP PowerShell Demo. Custom SPA page with AngularJs Material
...
```sh
git clone https://github.com/Zerg00s/splists-material.git
```
...
To view the custom SPA page you've deployed - navigate to the `/YOUR_SITE/_catalogs/masterpage/material/app-view2.aspx`